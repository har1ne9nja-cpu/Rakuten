...
- 例外：当日終了のクーポン等、時限性のあるキャンペーンがある場合は黄金時間より前倒しして投稿してよい（2026-08-25、Yunthのクーポンが23:59終了のため20:00投稿に前倒しした例あり）
- サブで使う時間帯：（未使用）
- 1日の投稿数：1投稿（立ち上げ期のため）
...
- **2026-08-12訂正**：松山油脂も検索キーワードを変えて確認したところ、同じく「投稿を確認」に誘導されることが判明。当初「再投稿できる」としたのは誤りだった。**結論：一度投稿した商品は、基本的に新規の別投稿としては再投稿できない**（アプリ全体の仕様の可能性が高い）。今後は「1〜2週間空けて再投稿」という運用を前提にせず、**毎回新しい商品を固定候補リストに補充し続ける**運用に切り替える。products.mdの優先度も、一度投稿した商品はC（再投稿不可）として扱い、新規発掘した商品を優先する
